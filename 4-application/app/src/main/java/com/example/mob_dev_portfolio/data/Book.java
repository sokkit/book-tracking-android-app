...
public class Book {
    ...
    public Book(String authors, String title, int status, String dateStarted, String dateCompleted, String review, float rating, String thumbnail, String description, String dateAdded) {
